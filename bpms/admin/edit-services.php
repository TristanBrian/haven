...
if(isset($_POST['submit']))
 ...
 $eid=$_GET['editid'];
    ...
    $query=mysqli_query($con, "update  tblservices set ServiceName='$sername',ServiceDescription='$serdesc',Cost='$cost',BookingFee='$bookingfee',Duration='$duration' where ID='$eid' ");
    if ($query) {
...
<html>
<head>
<title>Haven Spa| Update Services</title>
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">Booking Fee</label> <input type="text" id="bookingfee" name="bookingfee" class="form-control" placeholder="Booking Fee" value="<?php  echo $row['BookingFee'];?>"> </div>
							 <div class="form-group"> <label for="exampleInputPassword1">Duration (minutes)</label> <input type="number" id="duration" name="duration" class="form-control" placeholder="Duration" value="<?php  echo $row['Duration'];?>" min="1"> </div>
