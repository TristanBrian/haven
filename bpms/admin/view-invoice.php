...
<html>
<head>
<title>Haven Spa|| View Invoice</title>
...
<?php
$ret=mysqli_query($con,"select tblservices.ServiceName,tblservices.Cost,tblservices.BookingFee,tblinvoice.Duration  
    from  tblinvoice 
...
<td><?php echo $subtotal=$row['Cost'] + $row['BookingFee']?></td>
</tr>
<?php 
$cnt=$cnt+1;
$gtotal+=$subtotal;
