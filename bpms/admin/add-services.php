...
move_uploaded_file($_FILES["image"]["tmp_name"],"images/".$newimage);
    ...
    $query=mysqli_query($con, "insert into tblservices(ServiceName,ServiceDescription,Cost,BookingFee,Duration,Image) values('$sername','$serdesc','$cost','$bookingfee','$duration','$newimage')");
    if ($query) {
...
<html>
<head>
<title>Haven Spa | Add Services</title>
...
<body class="cbp-spmenu-push">
    ...
    echo $msg;
							 ...
							 <div class="form-group"> <label for="exampleInputEmail1">Service Description</label> <textarea type="text" class="form-control" id="sername" name="serdesc" placeholder="Service Name" value="" required="true"></textarea> </div>
							  ...
							  <div class="form-group"> <label for="exampleInputPassword1">Booking Fee</label> <input type="text" id="bookingfee" name="bookingfee" class="form-control" placeholder="Booking Fee" value="0" required="true"> </div>
							  <div class="form-group"> <label for="exampleInputPassword1">Duration (minutes)</label> <input type="number" id="duration" name="duration" class="form-control" placeholder="Duration" value="30" min="1" required="true"> </div>
