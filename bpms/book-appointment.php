...
if(isset($_POST['submit']))
  {
    ...
    try {
        // Debug output
        error_log("Attempting to book appointment with data: " . print_r($_POST, true));
        
        $query = mysqli_query($con,"INSERT INTO tblbook(UserID,AptNumber,AptDate,AptTime,Message,Services) VALUES('$uid','$aptnumber','$adate','$atime','$msg','$services')");
        ...
        if ($query) {
            ...
            if(mysqli_num_rows($ret) > 0) {
                ...
                throw new Exception("Could not retrieve appointment number");
            }
        }
    } catch (Exception $e) {
        error_log("Booking Error: " . $e->getMessage());
        echo '<div class="alert alert-danger">Error: ' . htmlspecialchars($e->getMessage()) . '</div>';
        echo '<script>console.error("Booking Error: ' . addslashes($e->getMessage()) . '");</script>';
    }
...
<html lang="en">
  <head>
    ...
    <title>HAVEN SPA| Appointment Page</title>
...
<section class="w3l-inner-banner-main">
 ...
 Book Appointment
            ...
            <p class="tiltle-para ">Find and make reservations for your desired beauty/spa service.</p>
        </div>
</div>
</div>
...
?>
                    <div class="cont-top">
                        ...
                        <div class="cont-right">
                            <h6>Call Us</h6>
                            <p class="para"><a href="tel:+254-712-046-110">+<?php  echo $row['MobileNumber'];?></a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Email Us</h6>
                            <p class="para"><a href="mailto:lessusbrian7@gmail.com" class="mail"><?php  echo $row['Email'];?></a></p>
                        </div>
                    </div>
                    <div class="cont-top margin-up">
                        <div class="cont-left text-center">
               ...
               <?php } ?> </div>
                <div class="map-content-9 mt-lg-0 mt-4">
                    <form method="post">
                        ...
                        <select class="form-control" name="services[]" multiple required>
                        <?php
                        $services = mysqli_query($con,"SELECT * FROM tblservices");
                        while($service = mysqli_fetch_array($services)) {
                            echo '<option value="'.$service['ID'].'">'.$service['ServiceName'].' (KSH '.number_format($service['Cost']).')</option>';
                        }
                        ?>
                        </select>
